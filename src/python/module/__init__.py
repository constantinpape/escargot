...
def affinity_watershed_2d_blockwise(affinities, upper_threshold, lower_threshold, size_threshold, region_threshold, block_shape):
    ...
    from escargot_module import get_node_weights, run_graph_watershed, merge_subblocks#, apply_size_filter

    node_weights = get_node_weights(affinities, upper_threshold, lower_threshold, False)
